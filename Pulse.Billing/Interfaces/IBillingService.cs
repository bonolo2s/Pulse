...
{
    Task ProcessPaymentResultAsync(string paymentReference, string? eventId, string status, string? channel, string? email, Guid? userId, PaystackAuthorization? authorization);
